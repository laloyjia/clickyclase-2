/**
 * seed-demo.mjs — Click&Clase
 * ─────────────────────────────────────────────────────────────
 * Puebla el colegio demo `colegio-demo` con datos realistas
 * (100% genéricos, sin referencias a colegios reales) para
 * demostrar TODAS las funciones del sistema.
 *
 * Crea:
...
// CONFIGURACIÓN
// ═══════════════════════════════════════════════════════════════
const LICEO_SLUG    = 'colegio-demo';
const LICEO_NOMBRE  = 'Colegio Demo Click&Clase';
...
async function crearLiceo() {
  ...
  await db.collection('liceos').doc(LICEO_SLUG).set({
    ...
    comuna:    'Ciudad Demo',
    direccion: 'Av. Principal 100, Ciudad Demo',
...
async function crearFuncionarios() {
  ...
  const staff = [
    // Directivos
    { rol: 'rector',        nombre: 'Rector Juan Salinas Herrera',     email: 'rector' },
