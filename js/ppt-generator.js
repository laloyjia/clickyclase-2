...
(function () {
  ...
  CCPptGenerator.prototype._construirPromptGemini = function () {
    ...
    return [
      ...
      '}',
      '',
      '════ ESTRUCTURA DE LA CLASE (arco completo, diseño instruccional) ════',
      'Arma el array "slides" para que, junto con portada/aprendizajes/actividad/cierre, la clase tenga este arco profesional, en ORDEN:',
      '  1) PORTADA → la cubre el bloque "portada".',
      '  2) OBJETIVOS y AGENDA → los cubren "aprendizajes" (objetivos) y el índice que se genera solo.',
      '  3) ENGANCHE INICIAL (1 slide, momento "Inicio"): dato sorprendente, pregunta potente o problema real que motive.',
      '  4) DESARROLLO (varios slides, momento "Desarrollo"): el contenido nuevo, progresivo, UNA idea por slide.',
      '  5) EJEMPLO / CASO APLICADO (1 slide, momento "Práctica guiada"): un ejemplo resuelto paso a paso o un caso real.',
      '  6) CHEQUEO RÁPIDO (1 slide corto, momento "Desarrollo", título "Chequeo rápido"): 1-2 preguntas para verificar comprensión a mitad de clase.',
      '  7) PUNTOS CLAVE (1 slide, momento "Cierre", título "Puntos clave"): resumen de lo esencial en 3-5 bullets.',
      '  8) REPASO RÁPIDO (1 slide, momento "Cierre", título "Repaso rápido"): 2-3 preguntas de repaso para consolidar.',
      '  9) RECURSOS (ÚLTIMO slide, momento "Cierre", título "Para seguir aprendiendo"): 2-3 recursos/fuentes concretas para profundizar.',
      'La ACTIVIDAD y el CIERRE los cubren sus bloques dedicados.',
      c.estilo ? ('Adapta el tono y la profundidad al estilo pedagógico "' + c.estilo + '".') : '',
      'Ajusta la cantidad al N° de slides pedido (' + c.nSlides + '): si son pocos, prioriza gancho + desarrollo + puntos clave + repaso; si son muchos, expande el desarrollo. Los ~' + nContenido + ' slides de contenido incluyen todo lo anterior (3 a 9).',
      '',
      '════ ANCLAJE CURRICULAR ════',
      ...
      '',
      '════ TÍTULOS Y GANCHO ════',
      '- titulo general: ATRACTIVO y con curiosidad, NO genérico. Ej: en vez de "El transistor como interruptor" → "Cómo un chip diminuto enciende y apaga un millón de veces por segundo".',
      '- portada.resumen: una PREGUNTA o frase-gancho que despierte curiosidad y conecte con la vida real; no un resumen plano.',
      '- Títulos de slide: concretos, una idea por slide; que en conjunto cuenten una historia con hilo conductor de principio a fin.',
      '',
      '════ BULLETS CONCRETOS (nada genérico) ════',
      '- Cada bullet aporta algo ESPECÍFICO: un dato, cifra, ejemplo real, caso o comparación. Prohibido el relleno vago.',
      '  MAL: "permite muchas conmutaciones". BIEN: "conmuta ~1.000 millones de veces/seg sin desgaste, a diferencia de un interruptor mecánico".',
      '- Contextualiza a Chile, a la vida del estudiante y —si es TP— a la especialidad y su campo laboral.',
      '- Combina niveles de pensamiento (recordar → comprender → aplicar → analizar → crear) sin nombrar taxonomías.',
      '',
      '════ INTERACCIÓN Y DINAMISMO ════',
      '- En el DESARROLLO incluye una pregunta desafiante tipo "¿Qué pasaría si...?" para hacer pensar a la clase.',
      '- Las preguntas del cierre van de menor a mayor exigencia cognitiva.',
      '',
      '════ NOTAS Y ACTIVIDAD ════',
      '- notasProfesor: español chileno, tono cercano; incluye qué decir, UNA pregunta para lanzar a la clase y un tiempo sugerido.',
      '- actividad: concreta y REALIZABLE en el aula con recursos habituales. descripcion con líneas para Materiales, Criterios de logro y Diferenciación (DUA/NEE), separadas por salto de línea (\\n).',
      '',
      '════ REGLAS DE FORMATO ════',
      '- UNA idea principal por slide. Texto conciso, sin párrafos largos.',
      '- Bullets: máximo 5 por slide, cada uno máx 12 palabras.',
      '- sugerenciaImagen: EN INGLÉS, un OBJETO CONCRETO y fotografiable (3 a 5 palabras), buscando FOTO REAL Y LIMPIA. Agrega pistas como "closeup", "white background", "isolated" o "real photo" cuando ayuden a obtener una imagen prolija.',
      '  BIEN: "black npn transistor closeup white background", "human heart anatomy real photo", "solar panel roof isolated".',
      '  MAL (evitar, dan capturas sucias con flechas/UI): "circuit diagram", "tutorial screenshot", "abstract illustration", "colorful diagram".',
      '  Para conceptos abstractos usa el objeto físico más representativo (ej: "flujo de corriente" → "copper electric wire closeup").',
