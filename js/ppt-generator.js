...
(function () {
  ...
  CCPptGenerator.prototype._construirPromptGemini = function () {
    ...
    return [
      ...
      '- Incluye al menos un slide de DESARROLLO con una pregunta desafiante tipo "¿Qué pasaría si...?" para hacer pensar a la clase.',
      '- Inserta UN check formativo a mitad de la clase: un slide corto (momento "Desarrollo", título tipo "Chequeo rápido") con 1-2 preguntas para verificar comprensión.',
