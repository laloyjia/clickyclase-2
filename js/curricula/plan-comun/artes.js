...
CURRICULA_PLAN_COMUN['artes'] = {
  ...
  oas: {
    ...
    '3B': [
      ...
      {codigo:'OA6', eje:'Comunicar y difundir', descripcion:'Presentar y compartir sus trabajos de arte y los de sus pares, expresando opiniones acerca de los procesos y resultados.'}
    ],
    '4B': [
      ...
      {codigo:'OA6', eje:'Comunicar y difundir', descripcion:'Presentar sus trabajos de arte y los de sus pares, integrando criterios como la temática, los procesos artísticos, los materiales utilizados, entre otros.'}
    ],
    ...
    '5B': [
      ...
      {codigo:'OA6', eje:'Comunicar y difundir', descripcion:'Comunicar oralmente sus impresiones, percepciones y observaciones sobre obras de arte y diseños, considerando el tema, las relaciones entre sentimientos y formas de expresión, los aspectos formales y técnicos.'}
    ],
    ...
    '6B': [
      ...
      {codigo:'OA6', eje:'Comunicar y difundir', descripcion:'Comunicar y difundir sus trabajos de arte y diseños usando recursos digitales, audiovisuales y/o tradicionales, comentando sus elecciones de medios.'}
    ],
